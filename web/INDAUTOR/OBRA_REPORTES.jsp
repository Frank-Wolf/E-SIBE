                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                <li><a href="OBRA_REPORTES">Obras reportados por Docentes</a></li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-md-6" >
                        ...
                        <s:form action="registra_obra" method="post">
                            ...
                            <s:textfield name="num_autores" label="Número de Autores" cssClass="form-control"/>
                    ...
                    <div class="col-md-6" style = "margin-left:-120px;">
                        ...
                        <%
                            ...
                            out.print("</tr>");
                                ...
                                while(ob.next())
                                {
                                    ResultSet d=lb.executeQuery("SELECT * FROM obra where id_obra='"+ob.getString("id_obra")+"' ");
                                    while(d.next()){
                                out.print("<tr>");
                                out.print("<th>");
                                ...
                                out.print("</th>");
                                out.print("<td>");
                                out.print(d.getString("nom_obra"));
                                out.print("</td>");
                                out.print("<td>");
