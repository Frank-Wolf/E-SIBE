            ...
            <s:div cssClass="site-wrapper-inner">
                ...
                <div class="row container-fluid cover-container2" >
                    ...
                    <div class="col-md-4 col-md-offset-1">
                        <h2 class="h3">Lista de usuarios DES activos</h2>
                        ...
                        while (rs.next())
                        {
                            ...
                            out.print("<a href='Borrar_DES?id_usuario="+rs.getString("id_usuario")
                                    +"'>Borrar</a>");
                            out.print("</td>");
                            out.print("<td>");
                            out.print("<a href='/login/Admins/modifica_DES.jsp?id="
                    ...
                    <div class="col-md-4 col-md-offset-1">
                        <h2 class="h3">Registrar nuevo usuario DES</h2>
                        <s:set name="counter" value="#varName"/>
                        <s:set name="u_a" value="%{'DES'}" />
                        <s:set name="periodo" value="%{0}" />
                        <s:set name="idTypeUsuario" value="%{15}" />
                        <s:form id="datos3" action="/Usuario/Registra_DES">
