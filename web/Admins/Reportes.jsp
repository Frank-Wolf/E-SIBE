<%-- 
    Document   : Reportes
    Created on : 22/05/2017, 01:59:48 PM
    Author     : le_as
--%>
                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                <li><a href="Reportes_Evaluadores">Evaluadores - Profesores</a></li>
                                <li><a href="Reportes_Actividades">Actividades Registradas</a></li>
