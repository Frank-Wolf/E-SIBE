<%-- 
    Document   : modifica_feacti
    Created on : Feb 23, 2017, 6:57:42 PM
    Author     : PsysacElrick
--%>
        ...
        <s:div cssClass="contenedor-general">
            <s:div cssClass="site-wrapper-inner">
                ...
                <%
                    ...
                    ResultSet rs=null;
                    lb.getConnection();
                    rs=lb.executeQuery("SELECT * FROM fecha_actividades WHERE id_fecha="+fecha);
                    rs.next();
                ...
                <s:div cssClass="cover-inner" align ="center">
                    <s:form action="/Usuario/Modifica_fechaacti" method="post">
