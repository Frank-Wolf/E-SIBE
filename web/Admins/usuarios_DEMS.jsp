...
<html>
    <head>
        ...
        <title>Inicio administrador DES</title>
    </head>
            ...
            <s:div cssClass="site-wrapper-inner">
                <nav class="navbar navbar-default">
                    <div class="container">
                        <div class="navbar-header">
                            <a class="navbar-brand">E-SIBE: Administrador DEMS</a>
                        </div>
                ...
                <div class="row container-fluid cover-container2" >
                    ...
                    <div class="col-md-4 col-md-offset-1">
                        <h2 class="h3">Lista de usuarios DEMS activos</h2>
                        ...
                        while (rs.next())
                        {
                            ...
                            out.print("<a href='Borrar_DEMS?id_usuario="+rs.getString("id_usuario")
                                    +"'>Borrar</a>");
                            out.print("</td>");
                            out.print("<td>");
                            out.print("<a href='/login/Admins/modifica_DEMS.jsp?id="
                    ...
                    <div class="col-md-4 col-md-offset-1">
                        <h2 class="h3">Registrar nuevo usuario DEMS</h2>
                        <s:set name="counter" value="#varName"/>
                        <s:set name="u_a" value="%{'DEMS'}" />
