        ...
        <s:div cssClass="contenedor-general">
            <s:div cssClass="site-wrapper-inner">
                ...
                <div class="row container-fluid" >
                    ...
                    <div cssClass="" align ="center" onload="show_form('<%=n%>')">
                        <s:set var="id_actividad"><%=user%></s:set>
                        <s:form action="/Usuario/evalua_2_5" id="form1">
                        ...
                        <s:form action="/Usuario/evalua_2_5" id="form2">
                            <s:select label="Seleccione si es aceptado o no" cssClass="form-control"
                                      headerKey="-1" headerValue="Seleccione"
                                      list="# {
                                      'Aceptado':'Aceptado',
                        ...
                        <s:form action="/Usuario/evalua_2_5" id="form3">
                            <s:select label="Seleccione si es aceptado o no" cssClass="form-control"
                                      headerKey="-1" headerValue="Seleccione"
                                      list="# {
                                      'Aceptado':'Aceptado',
