            ...
            <s:div cssClass="site-wrapper-inner">
               <nav class="navbar navbar-default">
                ...
                <s:div cssClass="cover-container2">    
                    <div class="row " align="center">
                        <div class=" col-xs-12 col-sm-8 col-md-8 col-lg-8 
                         ...
                         col-sm-offset-2 ">
                            ...
                            <h2 class="titulos" >Publicaciones Con Arbitraje Reportadas</h2>
                            <br/>
                            <br/>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="titulos" align="center">Publicaciones Reportadas por los Docentes</h2>
                            <br/>

                            <%
                                lb.getConnection();
                                ResultSet beifi=lb.executeQuery("select * from publicacion where id_tipo_pub=4 OR id_tipo_pub=5 ;");
