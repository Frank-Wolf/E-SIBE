<%-- 
    Document   : Envia_apela_2_2
    Created on : May 7, 2017, 2:49:10 PM
    Author     : PsysacElrick
--%>
...
<html>
    ...
    <body background="../css/textura.png" class="boding overflow">
        ...
        <s:form id = "datos" action="/Usuario/upload_file_apela_22" method="post" enctype="multipart/form-data">
