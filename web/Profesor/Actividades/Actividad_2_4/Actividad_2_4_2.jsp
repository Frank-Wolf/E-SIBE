<%-- 
    Document   : Actividad_4
    Created on : 31/01/2017, 10:09:50 AM
    Author     : le_as
--%>
                ...
                <nav class="navbar navbar-default">
                    <div class="container">
                        <div class="navbar-header">
                            <a class="navbar-brand" >Actividad 2.4</a>
                        </div>
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                
                                <li class="active"><a href="Actividad_2_4">Validar trabajos de Investigacion</a></li>
