<%-- 
    ...
    Created on : 31/01/2017, 10:50:32 AM
    Author     : le_as
--%>
                ...
                <nav class="navbar navbar-default">
                    <div class="container">
                        <div class="navbar-header">
                            <a class="navbar-brand" >Actividad 2.1</a>
                        </div>
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                <li ><a href="Actividad_2_1_1">Alumnos BEIFI</a></li>
                                <li ><a href="Actividad_2_1_2">Alumnos Servicio Social</a></li>
                            </ul>
