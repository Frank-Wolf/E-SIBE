<%-- 
    Document   : Actividad_2
    Created on : 31/01/2017, 10:09:26 AM
    Author     : le_as
--%>
        ...
        <s:div cssClass="contenedor-general">
            <s:div cssClass="site-wrapper-inner">
                ...
                <nav class="navbar navbar-default">
                    <div class="container">
                        <div class="navbar-header">
                            <a class="navbar-brand" >Actividad 2.2.1</a>
                        </div>
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="#">Validar Publicación</a></li>
                                <li><a href="Actividad_2_3">Menu anterior</a></li>
                            </ul>
                ...
                <s:div cssClass="cover-container">    
                    ...
                    <h2 class="titulos">Institucional con resumen publicado</h2>
