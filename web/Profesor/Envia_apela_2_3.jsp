<%-- 
    Document   : Envia_apela_2_3
    Created on : May 7, 2017, 2:49:31 PM
    Author     : PsysacElrick
--%>
...
<html>
    ...
    <body background="../css/textura.png" class="boding overflow">
        ...
        <s:form id = "datos" action="/Usuario/upload_file_apela_23" method="post" enctype="multipart/form-data">
